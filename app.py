...
if st.button("Load & Index Page"):
    if not url:
        ...
        # Step 3 & 4: Create embeddings and store in PostgreSQL (pgvector)
        with st.spinner("Creating embeddings & storing in PostgreSQL..."):
            st.write("PGVECTOR_URL:", PGVECTOR_URL)
